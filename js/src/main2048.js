        ...
        for(var i = 0;i<4;i++){  
            for ( var j = 0; j < 4; j++) {  
                ...
                if(board[i][j] == 0){  
					...
					if (board[i][j]>4) theNumberCell.css("color", getNumberColor(board[i][j]));  
					else theNumberCell.css("box-shadow","0 0 30px 10px rgba(243, 215, 116, 0), inset 0 0 0 1px rgba(255, 255, 255, 0);")
